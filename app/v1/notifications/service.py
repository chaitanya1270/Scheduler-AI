...
def should_send_notification(meeting: models.Meeting, participant: models.MeetingParticipant, last_notified: datetime) -> bool:
    ...
    next_notification_time = last_notified + frequency
...
def send_periodic_notifications():
    ...
    try:
        ...
        for participant in pending_participants:
            ...
            # Assuming you have a field 'last_notified' in MeetingParticipant
            # If not, you need to add it to track when the last notification was sent
            # For this example, let's assume it's not present and always send
            should_notify = True  # Replace with actual logic if 'last_notified' exists
            ...
            if should_notify:
                ...
                # Update last_notified time if applicable
